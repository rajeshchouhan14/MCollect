Feature: VerifyCSOAnalystportalAccess Regression suite

  Scenario Outline: As a user, Verify portal access of CSO Analyst

    Given I am on the CSOanalyst login page 
